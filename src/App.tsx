 ...
 * @component
 */
const socket = io("https://gokapture-digital-mosaic-backend-env.eba-edyt79ku.ap-south-1.elasticbeanstalk.com", {
...
function App() {
  ...
  useEffect(() => {
    axios.get("https://gokapture-digital-mosaic-backend-env.eba-edyt79ku.ap-south-1.elasticbeanstalk.com/cache-images").then((e) => {
      // setGridData()
